...
class Summa(Operaatio):
    ...
    def suorita(self):
        global HISTORY
        global PREV_FUNC
        HISTORY = self._sovelluslogiikka.tulos
        PREV_FUNC = self
        return self._sovelluslogiikka.plus(int(self._syote()))

    def kumoa(self):
        global HISTORY
        self._sovelluslogiikka.tulos = HISTORY
...
class Erotus(Operaatio):
    ...
    def suorita(self):
        ...
        HISTORY = self._sovelluslogiikka.tulos
        PREV_FUNC = self
        return self._sovelluslogiikka.miinus(int(self._syote()))
